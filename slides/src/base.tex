  ...
  \begin{columns}[c]
    \begin{column}{0.67\textwidth}
      \begin{figure}%
        ...
        \tikzstyle{idx} = [at end,font=\tiny]

        \tikzstyle{value} = [->,line width=0.5pt,red]
        \tikzstyle{memory} = [->,line width=0.5pt,blue]
        ...
        \begin{tikzpicture}
          ...
          \foreach \src/\dst/\idx/\kind/\pos in {%
            inmem/pf1/1/memory/above,
            inmem/pf2/1/memory/above,
            pf1/phi/1/memory/above,
            pf2/phi/2/memory/above,
            phi/gf/1/memory/above right,
            b/pf2/3/value/right,
          ...
          \draw[value] (a) .. controls +(-15:1cm) and +(90:1.5cm) .. (pf1)
            node[idx,above left] {2};
          \draw[value] (a) .. controls +(10:1cm) and +(70:3cm).. (pf2)
            node[idx,above right] {2};
